WY.models.GeoJSONLineCountries = (function(){
  function GeoJSONLineCountries(params){
  ...
  GeoJSONLineCountries.prototype = Object.create( THREE.Object3D.prototype );

  GeoJSONLineCountries.prototype.init = function(){
      ...
      _.each(geometry.coordinates, _.bind(function(coordinate){
        ...
        if (geometry.type == "MultiPolygon") {
          ...
          _.each(coordinate, _.bind(function(sub_coordinate){
            ...
            var country_line = new WY.models.CountryLine({
  ...
  GeoJSONLineCountries.prototype.find_country_by_name = function(name){
  ...
  GeoJSONLineCountries.prototype.convert_geometries_to_shapes =  function(coordinate) {
    var vertices = [];
  ...
  GeoJSONLineCountries.prototype.set_bounding_box = function(){
